...
#### Line 50: first dataset,   line 71: second dataset
...
####  Line 112 - 120: using linear regression
...
#### line 194 and 204: geom_point and geom_density

(B) .Rmd Line number(s) for use of multiple aesthetics:

#### Line 192 , 205 and 221, adding color and size

(C) .Rmd Line number(s) for use of layered graphics:  
#### Line 222, adding smoother
